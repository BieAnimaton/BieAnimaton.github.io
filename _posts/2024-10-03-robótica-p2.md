...
Mensurando: é o fenômeno sobre o qual deseja-se expressar uma medição.  
Ex: temperatura.
...
Chaves NA que fecham contato na presença de um campo magnético por um imã permanente.
...
Os materiais mais utilizados para a fabricação destes tipos de sensores são: platina, cobre ou níquel.
