...
- Suporte à GTI, deixa claro os processos e as condições envolvidas na requisição de serviços, permitindo melhores entregas.
...
Conjunto organizado de todos os serviços que uma organização de TI oferece a seus clientes, internos ou externos.
...
Mais importante porque permite às empresas:
...
- Alinhamento de expectativas: os clientes e usuários saberão exatamente qual resultado esperar de um determinado serviço e em quais condições serão entregadas.

- Transparência na prestação de serviços: sem um catálogo de serviços, o cliente não tem como saber que o serviço soliictado foge da responsabilidade da TI.

- Facilidade da comunicação: linguagem comum, alinhando a comunicação do departamento de TI e outras áreas.

- Aumento da credibilidade da TI: reconhecida e respeitada pelas demais áreas, um compromisso firmado entre os departamentos e a área de TI.
...
- Documento que funciona como um contrato e deve seguir normas estabelecidas pela ABNT, diz o que cada parte faz ou realiza.

- Descreve o que será entregue ou realizado, lista todos os serviços que serão ofertados às empresas.

- Nesse documento fica definido todo o escopo de trabalho a ser realizado, os prazos, as metas, o suporte que será oferecido, as regras de negócio e questões contratuais.

O SLA precisa ser revisado frequentemente para garantir que tudo está condizente.
...
Avaliar com o time interno se há espaço para esse grau de personalização.

Indicação para empresas com menos clientes ou clientes com especificações diferentes, replicação do modelo não é permitido.

### Foco no serviço

- Internal Service-Level Agreement.
- Mais utilizado por empresas com uma operação volumosa de clientes e serviços.
- Possibilidade de escalar estrategicamente o gerenciamento de projetos.
...
Referem-se aos gastos associados à infraestrutura e aos serviços de TI em uma organização.
...
Administração dos custos com base em um planejamento estrategioc voltado as necessidades do negocio.
...
- Traz procedimentos estruturados, baseados em estudos sólidos (empresas grandes que ja usaram tal metodo).
