...
Destinado aos clientes e usuários de TI, traz informações relevantes para a contratação do serviço (custos envolvidos, tempo do serviço, etc).
...
É importante porque permite as empresas:
...
- Alinhamento de expectativas: os clientes e usuários saberão exatamente qual resultado esperar de um determinado serviço e em quais condições serão entregues.
...
- Lista todos os serviços que serão oferecidos às empresas e descreve o que será entregue ou realizado (diz o que cada parte faz ou realiza).
